...
int alignBunnyWithProcrustes() {
	...
	const std::string filenameSource = std::string("/home/marc/3d/3dScanning/data/bunny/bunny_trans.off");
	const std::string filenameTarget = std::string("/home/marc/3d/3dScanning/data/bunny/bunny.off");
	...
	auto a = resultingMesh.getVertices();
	resultingMesh.writeMesh(std::string("/home/marc/3d/3dScanning/data/bunny/bunny_procrustes.off"));
